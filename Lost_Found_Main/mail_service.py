...
def send_claim_acception_mail(user, email):
    try:
        ...
        # print(e)
        return False
# send_claim_acception_mail(user, email)  # Testing the function
# send_claim_rejection_mail(email)  # Testing the function
# send_claim_rejection_mail('test@gmail.com')  # Testing the function
